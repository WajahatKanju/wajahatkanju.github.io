  ...
  return (
    <section className="about" id="about" aria-label="About Me">
      <div className="about__me--container">
        <h2>About Me</h2>
        <p>
          I am a coding enthusiast. I have a deep passion for all things related
          to computers and spend most of my time working on various coding
          projects. In addition to my love for technology, I also enjoy
        ...
        <p>
          ...
          projects on freecodecamp and earned certificates from Coursera. I have
          also tried out the Microverse program and have experience with
